...
class BookCollection {
  ...
  displaysection(e) {
    ...
    const mainSection = document.getElementById("section-list");
    const adderSection = document.getElementById("section-adder");
    const contactSection = document.getElementById("section-contact");
    console.log(contactSection);

    if (btnId === "listBtn") {
      mainSection.style.display = "block";
      adderSection.style.display = "none";
      contactSection.style.display = "none";
    }
    if (btnId === "addBtn") {
      mainSection.style.display = "none";
      adderSection.style.display = "block";
    }
    if (btnId === "contactBtn") {
    }
  }
